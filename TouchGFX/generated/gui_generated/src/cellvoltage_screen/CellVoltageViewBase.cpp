    ...
    flexButtonCallback(this, &CellVoltageViewBase::flexButtonCallbackHandler)
{
    ...
    scrollList1.setPosition(4, 0, 309, 435);
...
void CellVoltageViewBase::flexButtonCallbackHandler(const touchgfx::AbstractButtonContainer& src)
{
    ...
    {
        //Interaction1
        //When back_button clicked change screen to FrontPage
        //Go to FrontPage with no screen transition
        application().gotoFrontPageScreenNoTransition();
    }
}
