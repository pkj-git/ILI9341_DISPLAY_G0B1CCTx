...
CellVoltageBase::CellVoltageBase()
{
    setWidth(320);
    setHeight(27);
    Label.setXY(0, 1);
    ...
    Label.setTypedText(touchgfx::TypedText(T___SINGLEUSE_D72O));
    add(Label);

    Unit.setXY(262, 0);
    Unit.setColor(touchgfx::Color::getColorFromRGB(0, 0, 0));
    Unit.setLinespacing(0);
    Unit.setTypedText(touchgfx::TypedText(T___SINGLEUSE_MPM2));
    add(Unit);

    labelValue.setXY(174, 0);
    labelValue.setColor(touchgfx::Color::getColorFromRGB(0, 0, 0));
    labelValue.setLinespacing(0);
    Unicode::snprintf(labelValueBuffer, LABELVALUE_SIZE, "%s", touchgfx::TypedText(T___SINGLEUSE_GQPJ).getText());
    labelValue.setWildcard(labelValueBuffer);
    labelValue.resizeToCurrentText();
    labelValue.setTypedText(touchgfx::TypedText(T___SINGLEUSE_63OO));
    add(labelValue);
}
...
void CellVoltageBase::initialize()
{
