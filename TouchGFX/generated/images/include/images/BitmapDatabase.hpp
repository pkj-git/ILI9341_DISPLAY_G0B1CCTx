...
const uint16_t BITMAP_EASTMAN_LOGO_BRAND_RESIZE_ID = 2;
const uint16_t BITMAP_EATMAN_LOGO_ID = 3;
const uint16_t BITMAP_ICON_THEME_IMAGES_IMAGE_NAVIGATE_NEXT_50_50_E8F6FB_SVG_ID = 4;
const uint16_t BITMAP_ICON_THEME_IMAGES_NAVIGATION_CHEVRON_LEFT_50_50_E8F6FB_SVG_ID = 5;
